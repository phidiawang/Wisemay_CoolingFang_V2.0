...
PR_SECTION(adcLists)
  ...
  volatile char ADC1CommandList[COMMAND_NO][COMMAND_LENGTH] = {
	  ...
	  {0xC0,0xC9,0x00,0x00},	// end of sequence + no int [40], TEMP [C9], 4 clock cycles sample time [00], reserved [00]	
	  {0x00,0x00,0x00,0x00},	// end of list + no int [C0], phase voltage [CA]//{0xC0,0xCA,0x00,0x00}
	  {0x00,0x00,0x00,0x00},	
	  {0x00,0x00,0x00,0x00},	
	  {0x00,0x00,0x00,0x00},
	  {0x00,0x00,0x00,0x00},
